...
namespace Osma.Mobile.App.ViewModels.ProofRequests
{
    public class SelectAttributeValueViewModel : ABaseViewModel
    {
        ...
        public ProofRequestViewModel _proofRequestModel;

        public SelectAttributeValueViewModel(IUserDialogs userDialogs,
                                             INavigationService navigationService, ProofRequestViewModel proofRequest) : base(
            "tgytyiiijnjnjnlnj",
            userDialogs,
            navigationService)
        {
            _agentContextProvider = proofRequest._agentContextProvider;
            _connectionService = proofRequest._connectionService;
        ...
        private void BuildRequestedAttributesPredicatesMap(CredentialRecord proofCredential)
        {
            ...
            Attributes = newList;
            _proofRequestModel.Attributes = newList;
        ...
        {
            if (_proofCredential != null) BuildRequestedAttributesPredicatesMap(_proofCredential.CredentialRecord);
        ...
        {
            get => ProofCredentials.Count + " disponibles";
        }
